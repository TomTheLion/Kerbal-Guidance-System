...
global kgs_settings is lexicon(
	"ipu", 800,						// increase kOS operation speed
	...
	"debug_level", 0				// level 1 shows guidance vectors, level 2 shows basic iteration info, level 3 shows detailed interation info, level 4 shows jacobian info
).